...
| `core.specialist-routing` | `block-distill.worker`, on-event | per-specialist (`3-1-regulations`, `3-2-knowledge-clone`, `3-3-decisions`, `3-4-project-customer`, `3-5-insights`, `3-6-ideas`, `3-8-helpfulness`, `3-13-sprint-helper`, `tracker-ingest`) | 2-4 | Маршрутизация в специалистов слоя 3. Sprint helper (2026-05-27) использует ту же очередь с jobName `3-13-sprint-helper`, payload `SprintHelperJobData{cycleId, tenantId, reason}`, concurrency=1, jobId-дедуп по cycleId. См. [[sprints]]. |
