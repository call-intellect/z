...
import { SwitchTurnModeSchema, type SwitchTurnModeDto } from './dto/admin-livekit.dto';
...
export class AdminLiveKitController {
  constructor(@Inject(AdminLiveKitService) private readonly svc: AdminLiveKitService) {}
  ...
  @Get('egress')
  @ApiOperation({
    summary: 'Активные egress-задачи (EgressClient.listEgress({active: true})).',
  })
  getEgress() {
