...
См. `04_не-сделано` (строки 2026-06-17): DESIGN.md-merge (конфликт аудита), ~1100 спорных knip-кандидатов, гигиена plans/ (архивация ~90 ТЗ + ~1300 битых ссылок в исторических доках), полный ре-индекс `index.md` + добивка «update»-доков.
