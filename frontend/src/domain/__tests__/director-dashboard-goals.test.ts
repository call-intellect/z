/**
 * Unit-тесты мапперов дерева целей дашборда (Goals OKR v2, Фаза 4 — frontend).
 *
 * Проверяем:
 *   - goalTreeNodeFromApi: рекурсия по children + санитайзеры enum,
 *   - goalTreeNodeToRenderNode: адаптация в обобщённый render-узел.
 */
