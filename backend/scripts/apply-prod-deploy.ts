...
const STEPS: Step[] = [
  ...
  { phase: 'seed-base', script: 'scripts/seed-admin-setting-dialog-layer.ts', hint: 'dialog_layer.query_history_pairs=4 — глубина истории модуля понимания запроса (ТЗ 2026-06-14 слитый dialog-layer)' },
  { phase: 'seed-base', script: 'scripts/seed-admin-setting-concierge.ts', hint: 'concierge.history_pairs=4 + concierge.clarify_min_confidence=80 — крутилки помощника (ТЗ 2026-06-14 assistant-router)' },
  { phase: 'seed-base', script: 'scripts/seed-admin-setting-work-hours.ts', hint: 'work_hours_default_{start,end} + work_days_default + default_timezone — дефолты рабочего профиля (calendar-master Ф4)' },
  { phase: 'seed-base', script: 'scripts/seed-admin-setting-chat-v2-tables.ts', hint: 'chat_v2.table_context_max_rows=20 + max_tables=2 — лимиты параллельной ветки умных таблиц chat_v2 (ТЗ 2026-06-15 §7 ЧАСТЬ B)' },
  ...
  { phase: 'seed-base', script: 'scripts/seed-admin-setting-knowledge-base-redesign.ts', hint: 'knowledge_base.redesign.enabled kill-switch (Ф5 редизайн раздела «База знаний»)' },
