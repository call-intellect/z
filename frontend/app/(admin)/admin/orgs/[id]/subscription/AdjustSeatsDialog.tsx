      ...
      <DialogContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <DialogHeader>
            ...
            <DialogDescription>
              Текущее значение доп. мест: <strong>{currentSeatsExtra}</strong>.
              Базовое место (хост) не изменяется. При увеличении бэкенд
              автоматически создаст pro-rata-инвойс на доплату.
            </DialogDescription>
          </DialogHeader>

          <div className="space-y-2">
            <Label htmlFor="adjustSeats-new">
              Новое количество доп. мест <span className="text-danger">*</span>
            </Label>
            <Input
              id="adjustSeats-new"
              type="number"
