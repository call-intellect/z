...
const SEEDS: SettingSeed[] = [
  ...
  },
  {
    ...
    section: 'orchestrator',
    severity: 'medium',
    description: 'Максимум суб-агентов на один прогон оркестратора. По умолчанию 5.',
  },
  {
...
async function main(): Promise<void> {
  console.log('=== seed-admin-setting-orchestrator START ===');
  ...
  console.log('=== seed-admin-setting-orchestrator DONE ===');
}

main()
  .catch((err) => {
    console.error('seed-admin-setting-orchestrator FAILED:', err);
    process.exit(1);
  })
  .finally(async () => {
