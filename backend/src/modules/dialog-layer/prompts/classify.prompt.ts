 ...
 *            show_tasks }.
 *
 * ТЗ 2026-06-10-cabinet-fixes-master §2 (rev4): расширили enum на 2 категории —
 * `task` (поставить задачу в трекер) и `show_tasks` (показать мои задачи).
 * Новые значения добавлены В КОНЕЦ enum-массива (минимизация дрейфа схемы);
 * правка SYSTEM-промпта инвалидирует prompt cache разово — приемлемо.
 *
  ...
  properties: {
    intent: {
      ...
      enum: [
        ...
        'note',
        // ТЗ 2026-06-10 §2 (rev4) — новые значения В КОНЕЦ массива (cache).
        'task',
        'show_tasks',
      ],
    },
