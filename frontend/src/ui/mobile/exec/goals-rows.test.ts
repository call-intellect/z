/**
 * Юнит-тесты чистой логики экрана «Цели» (мобайл, ТЗ B2/Ф3).
 *
 * Покрытие: выбор главной цели по весу, прогресс/тон по cachedAlignment, ряды
 * ключевых результатов (исключая главную) с drill на /goals/[id].
 */
