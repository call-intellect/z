...
- recommendations: 3–7 коротких пунктов «как сделать встречу лучше». severity = info / warning / critical (critical только при overall ≤ 40 или серьёзных провалах). category — одна из 5 категорий.
