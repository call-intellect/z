/**
 * Шаблоны должностей по отделу — используются на странице /roles
 * в онбординге (Блок B, шаг B3).
...
export const ROLE_TEMPLATES: Record<string, string[]> = {
  ...
  'сопровождение клиентов':   ['Менеджер по работе с клиентами', 'Старший менеджер'],
