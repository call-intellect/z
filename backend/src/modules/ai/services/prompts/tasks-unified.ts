...
const SELF_ASSIGNMENT_RULE = `Само-назначение: если автор реплики берёт задачу НА СЕБЯ («задача мне», «я сделаю», «беру на себя», «сделаю сам(а)») — исполнитель этой задачи = автор этой реплики (тот, кто говорит в этой строке диалога; его имя — префикс строки «Имя: …»). Если же говорящий ПЕРЕСКАЗЫВАЕТ чужие слова или цитирует другого — НЕ подставляй говорящего. Различай по смыслу. Если сомневаешься, кто исполнитель — assignee=null (честный сигнал), не угадывай.`;
