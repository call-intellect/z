...
const MEETINGS: MeetingItem[] = [
  {
    ...
    tasks: [
      {
        id: "t1",
        title: "Прислать пример webhook-payload для HubSpot",
        assignee: "Сергей",
        due: "10 мая",
        done: false,
      },
      {
        id: "t2",
        title: "Подготовить пилотный SOW с 90-дневным ROI",
        assignee: "Сергей",
        due: "13 мая",
        done: false,
      },
      ...
      {
        id: "t4",
        title: "Trial-доступ для 12 человек на 14 дней",
        assignee: "Сергей",
        due: "9 мая",
        done: true,
      },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t1",
        title: "Прислать кейс по custdev-отчётам Z",
        assignee: "Сергей",
        due: "11 мая",
        done: false,
      },
      {
        id: "t2",
        title: "Re-engage в августе, узнать про разморозку бюджета",
        assignee: "Сергей",
        due: "1 авг",
        done: false,
      },
  ...
  },
  {
    ...
    date: "Сегодня · 10:00",
    group: "today",
    summary: ["Обработка ещё идёт — отчёт появится через 2-3 минуты."],
    tasks: [],
    chapters: [],
    participants: [
      { initials: "СМ", name: "Сергей Мазуренко", isHost: true },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t1",
        title: "Прислать инвайт на pilot когда будет готов",
        assignee: "Сергей",
        due: "20 мая",
        done: false,
      },
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: "t2",
        title: "Запланировать kick-off с командой",
        assignee: "Сергей",
        due: "12 мая",
        done: true,
      },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t1",
        title: "Поднять микросервис BGE-M3 в инфре",
        assignee: "Дима К.",
        due: "5 мая",
        done: true,
      },
      {
        id: "t2",
        title: "Бенчмарк latency BGE vs OpenAI на 1000 chunks",
        assignee: "Маша Ш.",
        due: "8 мая",
        done: true,
      },
  ...
  },
  {
    ...
    tasks: [
      {
        id: "t1",
        title: "Записать в backlog: kazakh ASR",
        assignee: "Сергей",
        due: "—",
        done: true,
      },
  ...
  },
  {
    ...
    group: "earlier",
    summary: [
      "AI-pipeline упал на этапе транскрипции. Нужно перегенерировать.",
    ],
    tasks: [],
    chapters: [],
    participants: [],
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1 text-xs text-fg-tertiary">
        <Badge
          variant={
            item.type === "sales" || item.type === "demo"
              ? "default"
              : "secondary"
          }
        ...
        {participants.map((p, i) => (
          <div key={i} className="flex items-center gap-2">
            <Avatar className="h-7 w-7">
              <AvatarFallback
                className={p.isHost ? "bg-accent-muted text-accent" : ""}
              >
                {p.initials}
              </AvatarFallback>
            </Avatar>
  ...
  return (
    <div className="grid place-items-center py-24 text-center">
      ...
      <div className="mt-1 max-w-sm text-sm text-fg-secondary">
        Транскрипция и анализ занимают 2–4 минуты. Можно закрыть страницу —
        пришлём уведомление, когда будет готово.
      </div>
    </div>
  );
}
