...
Перечитай письмо глазами получателя: НОЛЬ внутренних оценок, температуры сделки, конкурентов, сомнений, готовности ЛПР. Только подтверждённые факты диалога. Если договорённостей не было — короткое честное письмо без выдуманных пунктов, не натягивай.`;
