...
const SEEDS: SettingSeed[] = [
  {
    key: 'documents.short_text_to_idea_threshold',
    value: 200,
    category: 'documents',
    section: 'documents',
    severity: 'low',
...
async function main(): Promise<void> {
  console.log('=== seed-admin-setting-documents START ===');
  ...
  console.log('=== seed-admin-setting-documents DONE ===');
}

main()
  .catch((err) => {
    console.error('seed-admin-setting-documents FAILED:', err);
    process.exit(1);
  })
  .finally(async () => {
