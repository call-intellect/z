          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                <span
                  className={`mt-0.5 inline-block w-4 h-4 shrink-0 rounded border text-center text-xs leading-4 ${
                    checked
