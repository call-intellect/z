...
> Реализовано целиком и смержено в main (PR #14, коммиты db8abc33 + af2f30a2). Все ключевые артефакты подтверждены кодом: enum+поле+индексы в Prisma, DbLoggerBridge в main.ts, log-pipeline хелперы, 50 инструментованных вор
