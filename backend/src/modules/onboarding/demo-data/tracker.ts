...
export const seedTracker: SeedFn = async (ctx: SeedContext, ids: IdMap): Promise<void> => {
  ...
  const projectDefs = [
    {
      ...
      name: 'Платформа v2.0',
      description:
        'Миграция на микросервисы, новый UI, OAuth2 авторизация. Целевой релиз — 1 июля 2026.',
    ...
    },
    {
      ...
      description:
        'iOS + Android клиенты для платформы. Дизайн-система, Push-уведомления, SDK видеозвонка.',
    ...
    },
    {
      ...
      name: 'Маркетинг Q2',
      description:
        'Лендинг v2, контент-план, вебинары, таргетированная реклама, партнёрская программа.',
  ...
  const allIssues: IssueDef[] = [
    ...
    },
    {
      ...
      board: 'plat_main',
      cycle: 'sprint14',
      labels: ['l_backend', 'l_security'],
      createdAt: daysAgo(8),
      description:
        'Текущий модуль авторизации на JWT без refresh-токенов. Необходимо мигрировать на OAuth2 + PKCE flow для поддержки внешних провайдеров (Google, Yandex, SberID). Затрагивает 3 микросервиса: auth-gateway, user-service, session-manager. Требуется backward-compatible API для мобильных клиентов v1.',
      checklist: [
    ...
    },
    {
      ...
      description:
        'Переезд с Docker Compose на Kubernetes (K8s). Включает: подготовку Helm charts, настройку namespace-ов, CI/CD pipeline для K8s, staging и prod окружения, документацию для DevOps.',
      checklist: [
    ...
    },
    {
      ...
      createdAt: daysAgo(7),
      description:
        'Адаптивный дизайн экрана видеозвонка для iOS и Android. Поддержка Picture-in-Picture, записи звонков, демонстрации экрана. Референсы: Zoom, Google Meet, но проще и легче. Упор на mobile-first UX: крупные кнопки, минимум элементов, быстрый доступ к mute/camera.',
    },
    {
      key: 'MOB-4',
      identifier: 'MOB-4',
    ...
    },
    {
      ...
      createdAt: daysAgo(16),
      description:
        'Целевая аудитория — CTO и DevOps малых компаний. Длительность 45 мин + 15 мин Q&A. Спикер: Дмитрий Козлов. Формат: live-демо миграции + разбор ошибок.',
    },
    {
      key: 'MKT-6',
      identifier: 'MKT-6',
    ...
    data: [
      {
        ...
        content:
          'Pipeline готов. staging деплоится за 3 минуты, prod — за 5 с canary-развёртыванием.',
        createdAt: daysAgo(14),
      },
      {
        issueId: ids.issues['PLAT-1']!,
        authorId: ownerUserId,
        content:
          'Отлично. Добавь в документацию схему pipeline для онбординга новых разработчиков.',
    ...
    data: [
      {
        ...
        authorId: ownerUserId,
        content:
          'Разделил гейтвей на 3 маршрута: /auth, /api, /ws. Rate-limiting на каждом отдельно.',
        createdAt: daysAgo(16),
      },
      {
        issueId: ids.issues['PLAT-3']!,
    ...
    data: [
      {
        ...
        authorId: ownerUserId,
        content:
          'Начал с аудита. Нашёл 4 уязвимости: нет rate limiting, JWT без expiration, нет CSRF-защиты, session fixation. Критично.',
        createdAt: daysAgo(7),
      },
      {
        issueId: ids.issues['PLAT-7']!,
      ...
      },
      {
        ...
        authorId: ownerUserId,
        content:
          'Принял. Rate limiting уже в PR, CSRF-токены добавлю завтра. OAuth2 flow спроектировал — см. чек-лист.',
        createdAt: daysAgo(5),
      },
    ],
  });
    ...
    data: [
      {
        ...
        authorId: ownerUserId,
        content:
          'Три варианта layout: grid, speaker-focus, sidebar. Для мобильного рекомендую speaker-focus как основной.',
        createdAt: daysAgo(5),
      },
      {
        issueId: ids.issues['MOB-3']!,
        authorId: ownerUserId,
        content:
          'Speaker-focus +1. Добавь кнопку «закрепить спикера» и свайп для переключения участников.',
        createdAt: daysAgo(4),
      },
    ],
  });
  ...
  await prisma.issueComment.createMany({
    data: [
      ...
      },
      {
        ...
        authorId: ownerUserId,
        content:
          'Прогон прошли — 43 минуты, в норме. Запись нужна для YouTube и нарезки коротких роликов.',
        createdAt: daysAgo(9),
      },
    ],
  });
  ...
  const docDefs: { title: string; project: string; content: object }[] = [
    {
      ...
      project: 'plat',
      content: tipTapDoc('Техническая архитектура v2', [
    ...
    },
    {
      ...
      project: 'plat',
      content: tipTapDoc('API-спецификация auth-service', [
    ...
    },
    {
      ...
      project: 'mob',
      content: tipTapDoc('Дизайн-система', [
    ...
    },
    {
      ...
      project: 'mob',
      content: tipTapDoc('UX-исследование: конкуренты', [
    ...
    },
    {
      ...
      project: 'mkt',
      content: tipTapDoc('Контент-план Q2', [
