...
const SEEDS: TaskRouteSeed[] = [
  ...
  },
  {
    ...
    playbookSection: '§2.1 block-distill (small JSON-in/JSON-out arbiter) + β-3 sub-TZ §11',
    chain: [
...
async function main(): Promise<void> {
  ...
  // eslint-disable-next-line no-console
  console.log(`=== seed-llm-task-routes-decisions START (updateExisting=${updateExisting}) ===`);
  // eslint-disable-next-line no-console
