...
const TRAITS: Array<{
...
}> = [
  {
    ...
    evidenceQuote:
      'Проводил парное программирование 3 дня — Игорь освоил рефакторинг auth-сервиса.',
    observedDaysAgo: 4,
  },
  {
    helperKey: 'kozlov',
    recipientKey: 'sokolova',
    traitType: 'help_provided',
    intensity: '0.700',
    topicHint: 'Demo стенд для Ростелекома',
    confidence: '0.850',
    visibility: 'public_team',
  ...
  },
  {
    helperKey: 'kozlov',
    recipientKey: null,
    traitType: 'proactive_hint',
    intensity: '0.750',
    topicHint: 'Security advisories',
    confidence: '0.800',
    visibility: 'internal',
  ...
  {
    helperKey: 'kozlov',
    recipientKey: 'sidorov',
    traitType: 'help_provided',
    intensity: '0.650',
    topicHint: 'TypeScript типы для API',
    confidence: '0.800',
    visibility: 'public_team',
  ...
  {
    helperKey: 'volkova',
    recipientKey: 'petrova',
    traitType: 'mentoring',
    intensity: '0.800',
    topicHint: 'Дизайн-ревью и приоритизация',
    confidence: '0.850',
    visibility: 'public_team',
  ...
  },
  {
    helperKey: 'volkova',
    recipientKey: null,
    traitType: 'emotional_support',
    intensity: '0.650',
    topicHint: 'Поддержка после стрессовой недели',
    confidence: '0.700',
  ...
  {
    helperKey: 'volkova',
    recipientKey: 'morozov',
    traitType: 'constructive_feedback',
    intensity: '0.750',
    topicHint: 'Roadmap чёткость',
    confidence: '0.800',
    visibility: 'internal',
  ...
  {
    helperKey: 'sokolova',
    recipientKey: 'lebedev',
    traitType: 'mentoring',
    intensity: '0.800',
    topicHint: 'B2B-продажи',
    confidence: '0.850',
    visibility: 'public_team',
  ...
  {
    helperKey: 'sokolova',
    recipientKey: 'volkova',
    traitType: 'help_provided',
    intensity: '0.600',
    topicHint: 'Customer voice',
    confidence: '0.800',
    visibility: 'public_team',
  ...
  },
  {
    ...
    traitType: 'mentoring',
    intensity: '0.700',
    topicHint: 'Управление перегрузом',
    confidence: '0.750',
    visibility: 'restricted',
...

  {
    ...
    traitType: 'mentoring',
    intensity: '0.750',
    topicHint: 'Design handoff в frontend',
    confidence: '0.850',
    visibility: 'public_team',
  ...
  },
  {
    ...
    traitType: 'proactive_hint',
    intensity: '0.600',
    topicHint: 'UX-проблема CallScreen',
    confidence: '0.800',
    visibility: 'internal',
  ...
  },
  {
    ...
    traitType: 'help_provided',
    intensity: '0.700',
    topicHint: 'Прототипы для CustDev',
    confidence: '0.850',
    visibility: 'public_team',
...
const CONTRIBUTION_BY_KEY = {
  morozov: {
    ideasInDevelopment: 2,
    ideasShipped: 5,
    thanksReceived: 9,
    thanksReceivedWeek: 1,
    currentCheckinStreak: 10,
    longestCheckinStreak: 18,
    helpfulComments: 6,
    probeQuestionsAnswered: 4,
  },
  volkova: {
    ideasInDevelopment: 4,
    ideasShipped: 8,
    thanksReceived: 12,
    thanksReceivedWeek: 2,
    currentCheckinStreak: 12,
    longestCheckinStreak: 20,
    helpfulComments: 9,
    probeQuestionsAnswered: 5,
  },
  kozlov: {
    ideasInDevelopment: 3,
    ideasShipped: 7,
    thanksReceived: 14,
    thanksReceivedWeek: 2,
    currentCheckinStreak: 8,
  ...
  sokolova: {
    ...
    thanksReceived: 10,
    thanksReceivedWeek: 2,
    currentCheckinStreak: 11,
    longestCheckinStreak: 16,
    helpfulComments: 7,
