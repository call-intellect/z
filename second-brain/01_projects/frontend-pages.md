...
- `/memory` — **дверь к реестрам (2026-06-25), НЕ кусочный поиск.** Кусочный `MemorySearch` (искал по памяти без агента и вываливал обрывки-чанки) **удалён**; `memory/page.tsx` — хаб-сетка ссылок на реестры (Решения / Оцифровано / Темы / Сущности / Таблицы / Идеи / Сигналы) + дверь **«Спросить у Мастера»** (Р3, ведёт на `/chat`, 2026-06-28). Глупого «Спросить у Коры с кусками» в интерфейсе больше нет.
