 ...
 * Коры — кто ответил / молчит / не видел / протух) видна только владельцу /
 * админу / COO. Сортировка карточек — как пришла с бэка (по severity).
 */
...
export function FeedClient() {
  ...
  // Контроль вопросов Коры — только владелец / админ / COO.
  const canControl =
