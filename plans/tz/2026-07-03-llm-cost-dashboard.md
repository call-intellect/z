...
- [x] Фаза 2 — backend: 5 эндпоинтов
- [x] Фаза 3 — бэкафилл 2026-05-09..2026-05-22
- [x] Фаза 4 — фронт: новый экран
- [x] Фаза 5 — уборка мёртвого кода
- [x] Фаза 6 — редирект 2 чистых витрин + nav
- [x] Фаза 7 — хирургия: список организаций
- [x] Фаза 8 — хирургия: юнит-экономика компании
- [x] Фаза 9 — хирургия + дедуп: деталь функции
