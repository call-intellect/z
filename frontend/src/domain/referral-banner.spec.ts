/**
 * Тест морфинга persistent-баннера партнёрской программы (B3).
 *
 * Проверяет чистую функцию выбора копи `referralBannerCopy` по роли
 * (руководитель / рядовой) и состоянию прогресса окупаемости.
 */
