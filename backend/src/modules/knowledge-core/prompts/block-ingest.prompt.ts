...
export const BLOCK_INGEST_JSON_SCHEMA: Record<string, unknown> = {
  ...
  properties: {
    blocks: {
      ...
      items: {
        ...
        properties: {
          ...
          roleHint: nullable({ type: 'string' }),
          commitmentDueDateGuess: nullable({ type: 'string' }),
          commitmentRecipientNameGuess: nullable({ type: 'string' }),
          sideHint: nullable({ type: 'string', enum: ['our', 'client', 'unknown'] }),
        },
      },
    },
    processes: {
      ...
      items: {
        ...
        properties: {
          ...
          ownerRoleHint: nullable({ type: 'string' }),
          triggerDescription: nullable({ type: 'string' }),
          confidence: { type: 'number', minimum: 0, maximum: 1 },
          sourceBlockIndex: nullable({ type: 'integer', minimum: 0 }),
        },
      },
    },
    decisions: {
      ...
      items: {
        ...
        properties: {
          ...
          decidedByPersonHint: nullable({ type: 'string' }),
    ...
    dataQuality: {
      ...
      properties: {
        speakerCoveragePercent: nullable({ type: 'number', minimum: 0, maximum: 100 }),
