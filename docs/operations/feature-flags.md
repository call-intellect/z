...
| Флаг | Сейчас | Почему не включаем | Что нужно от владельца |
|---|---|---|---|
| `goals.pulse.deliver_to_telegram` | ВЫКЛ | Внешне-наблюдаемое действие (рассылка людям в Telegram) — молча включать = риск спама | Явное «да» на рассылку пульса целей в ТГ |
