...
> 📦 **АРХИВ (аудит 2026-06-04): 🟢 почти реализовано — 88%.**
> Зонтичный roadmap-контракт, чья работа на ~88% реализована через ~20+ дочерних dated sub-ТЗ (sba-alpha/beta/gamma/delta-*), каждый из которых отслеживается отдельно. Все ключевые модели, модули, страницы, воркеры и кроны
