/**
 * Unit-тесты чистой функции `isReasoningRequired` (Фаза C3, detail-страница
 * курации). Обоснование обязательно когда:
 *   - уровень `deep` (для любого типа решения), ИЛИ
 *   - тип решения ∈ {split, merge, supersede, merge_categories, escalate}.
 */
