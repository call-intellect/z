/**
 * Unit-тесты чистых хелперов CardCorrectionActions (Фаза E2, лестница доверия).
 *
 * Покрываем:
 *   - correctConfirmLabel — подпись кнопки по роли (owner/admin vs остальные).
 *   - correctSuccessMessage — текст тоста по applied (сразу vs куратору).
 *   - pickChangedFields — отбор только реально изменённых полей + тримминг.
 */
