...
### [ ] Ф1 — Индекс `IdeaBlockEvidence` + единый резолв в `Person`
...
### [ ] Ф3 — Усиление разметки `team_friction` (block-ingest SYSTEM)
...
### [ ] Ф5 — Маршрут модели (DeepSeek Pro→GPT→KIE) + снять `maxTokens` + нагрузочный тест
