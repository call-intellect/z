...
related:
  - analysis/2026-05-XX-user-cabinet-design.md (не создан — пишется после ревью зонтичного, до 0c)
---
...
> - `plans/analysis/2026-05-XX-user-cabinet-design.md` _(будет создан между ревью этого ТЗ и стартом sub-TZ 0c)_ — структура личного кабинета, навигация, иерархия страниц. Sub-TZ 0c пишется на основе этой аналитики.
>
...
- **Аналитика ЛК** (`plans/analysis/2026-05-XX-user-cabinet-design.md`) пишется **между ревью этого зонтичного и стартом sub-TZ 0c**. Закрывает структуру ЛК, навигацию, иерархию страниц. 0a и 0b не блокируются ею (это backend).
