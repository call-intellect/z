...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    hint: 'goals.author_coverage_min + reliability.min_denominator + probe.* (Ф3.D) + blocker_synthesis.* + operations.blocker_synthesis.enabled (TZ-1 Ф3.A/B/C агенты исполнения)',
  },
  {
    phase: 'seed-base',
