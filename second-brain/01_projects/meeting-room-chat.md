...
Текстовый чат **внутри** видеовстречи (отдельно от AI-чата по результату). Реализован 2026-05-09 по `plans/archive/2026-05-09-meeting-room-chat.md`. До этого работал только в realtime через LiveKit DataChannel — теперь сохраняется в БД.
