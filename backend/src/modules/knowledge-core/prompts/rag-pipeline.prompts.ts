...
- fabricated=true и когда ответ УТВЕРЖДАЕТ статус/итог «готово/завершено/решено/актуализировано/закрыто/не блокирует/доволен», которого нет в блоках или который противоречит блокам (в блоках незакрыто/устарело/блокер — а ответ говорит обратное).
- fabricated=true и когда ответ приписывает провенанс — кто предложил, на какой встрече, как узнали, — которого нет в блоках.
