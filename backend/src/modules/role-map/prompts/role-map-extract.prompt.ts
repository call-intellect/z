...
export const ROLE_MAP_EXTRACT_SYSTEM_PROMPT = `Ты — аналитик «памяти компании». Извлекаешь нормализованную карту должности (Role Map) из наблюдений работы сотрудников.
