...
/**
 * ItemRow — одна строка таблицы items блока обратной связи.
 * Кнопка «Развернуть» подгружает полный текст исходного сообщения через
 * `GET /admin/feedback/topics/:id/items/:itemId/message` и показывает
 * его в развёрнутой строке.
 */
  ...
  return (
    <>
      <tr className="border-t border-border-subtle align-top">
        ...
        <td className="px-3 py-2 text-xs text-fg-secondary">
          {item.org ? item.org.name : <span className="text-fg-tertiary">—</span>}
        </td>
