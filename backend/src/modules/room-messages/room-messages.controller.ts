...
import { type SendRoomMessageDto, SendRoomMessageSchema } from './dto/send-room-message.dto';
...
export class RoomMessagesController {
  constructor(@Inject(RoomMessagesService) private readonly service: RoomMessagesService) {}
