...
> ⛔ **РЕШЕНИЕ ВЛАДЕЛЬЦА 2026-06-02: конфиденциальность СЕЙЧАС НЕ В ПРИОРИТЕТЕ.**
> На текущем этапе мы сознательно **не занимаемся** privacy/комплаенсом: то, что данные (транскрипты, файлы) уходят во внешний LLM (DeepSeek и т.п.), — это **ОК и не блокер**. Документ ниже сохранён как готовый research на будущее (когда дойдём до GTM в крупный B2B/госсектор). До тех пор: **не поднимать privacy как стоп-фактор, не предлагать privacy-доработки, ничего не «бояться» про DeepSeek/Китай.** Вернёмся к этому, когда владелец сам инициирует.
