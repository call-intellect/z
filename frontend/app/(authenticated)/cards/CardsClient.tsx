      ...
      <QueryGate
        ...
        empty={
          <EmptyState
            ...
            description="Создайте карточку клиента, сделки или проекта — и стартуйте встречу прямо из неё. Все встречи карточки будут собираться в её ленту, а Кора соберёт сводку."
            action={
              <Button onClick={() => setCreateOpen(true)} className="gap-2">
