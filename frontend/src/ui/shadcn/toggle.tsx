...
/**
 * Toggle — кнопка-переключатель (on/off). Бэкенд — `@radix-ui/react-toggle`,
 * чтобы получить корректную ARIA-семантику (aria-pressed, focus management).
 *
 * Используется для одиночных on/off-фильтров. Для множественного выбора —
