...
const MODEL =
  process.env.DIALOG_CLASSIFY_MODEL ?? process.env.DEEPSEEK_DEFAULT_MODEL ?? 'deepseek-v4-flash';
...
const CASES: Case[] = [
  {
    id: 'Q1',
    text: 'Какой бюджет на маркетинг в марте?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'факт',
  },
  {
    id: 'Q2',
    text: 'Расскажи, что обсуждали про найм',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'обзор',
  },
  ...
  {
    id: 'Q4',
    text: 'Что бы сказал клон маркетолога про каналы продвижения?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'клон',
  },
  {
    ...
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'вопрос к таблице',
  },
  {
    id: 'Q6',
    text: 'Напомни, что мы решили по Заречному?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'ловушка: «напомни», но это вопрос к памяти',
  },
  {
    id: 'Q7',
    text: 'Кто отвечает за договор с поставщиком?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'факт-кто',
  },
  {
    id: 'Q8',
    text: 'Сравни выручку за первый и второй квартал',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'анализ-сравнение',
  },
  {
    id: 'Q9',
    ...
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'вопрос про человека (pulse-инструмент)',
  },
  {
    id: 'Q10',
    text: 'Какие задачи у проекта внедрения 1С?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'ловушка: ЧУЖИЕ/проектные задачи = вопрос, не show_tasks',
  },
  {
    id: 'Q11',
    text: 'Что у Васи в календаре на завтра?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'чужой календарь = вопрос',
  },

  {
    ...
    kind: 'action',
    expectRoute: 'assistant',
    scenario: 'создать событие (create_event)',
  },
  {
    id: 'A2',
    ...
    kind: 'action',
    expectRoute: 'assistant',
    scenario: 'найти слот (find_free_slot)',
  },
  {
    id: 'A3',
    text: 'Отмени встречу в четверг',
    kind: 'action',
    expectRoute: 'assistant',
    scenario: 'отменить событие (delete_event)',
  },
  {
    id: 'A4',
    ...
    kind: 'action',
    expectRoute: 'assistant',
    scenario: 'создать встречу (create_meeting)',
  },

  {
    id: 'P1',
    text: 'План на день: КП Заречному, созвон с дизайнером, отчёт за апрель',
    kind: 'statement',
    expectRoute: 'checkin',
  ...
  {
    id: 'P2',
    text: 'Доброе утро, сегодня хочу закрыть КП и созвониться с Петровым',
    kind: 'statement',
    expectRoute: 'checkin',
    scenario: 'утренний план',
  },
  {
    id: 'R1',
    text: 'Итоги дня: КП отправил, созвон перенесли, отчёт не успел',
    kind: 'statement',
    expectRoute: 'checkin',
    scenario: 'вечерний отчёт',
  },
  {
    id: 'R2',
    text: 'Сегодня закрыл задачу А, по Б застрял на согласовании',
    kind: 'statement',
    expectRoute: 'checkin',
    scenario: 'отчёт пораньше (днём)',
  },
  {
    id: 'R3',
    text: 'Ещё забыл написать: дозвонился до поставщика, договорились на пятницу',
    kind: 'statement',
    expectRoute: 'checkin',
    scenario: 'второй отчёт-дополнение днём',
  },
  {
    id: 'R4',
    text: 'Сегодня сделал лендинг, не успел отчёт — помешало что не прислали данные. И придумал: давайте автоматизируем выгрузку.',
    kind: 'statement',
    expectRoute: 'checkin',
    scenario: 'отчёт + блокер + идея (микс)',
  },
  ...
  {
    id: 'N3',
    text: 'Была встреча с поставщиком, договорились снизить цену на 10%',
    kind: 'statement',
    expectRoute: 'ingest',
    scenario: 'пересказ встречи',
  },
  {
    id: 'N4',
    text: 'У нас постоянно проблема: заявки теряются между продажами и производством',
    kind: 'statement',
    expectRoute: 'ingest',
    scenario: 'проблема',
  },
  {
    id: 'N5',
    text: 'Процесс приёмки оборудования: проверка по накладной, тест-запуск, акт',
    kind: 'statement',
    expectRoute: 'ingest',
    scenario: 'описание процесса',
  },
  {
    id: 'N6',
    text: 'Подумал: наш онбординг слишком длинный, новички путаются в первую неделю',
    kind: 'statement',
    expectRoute: 'ingest',
    scenario: 'рефлексия',
  },
  ...
  {
    id: 'B2',
    text: 'Думаю, надо бы автоматизировать отчёты',
    kind: 'statement',
    expectRoute: 'ingest',
    scenario: 'мысль вслух (не задача)',
  },
  {
    id: 'B3',
    text: 'Опять клиенты жалуются на долгую доставку',
    kind: 'statement',
    expectRoute: 'ingest',
    scenario: 'проблема-заметка',
  },
  {
    id: 'B4',
    text: 'Закрыл 3 задачи, одна висит из-за смежников. Мысль: нужен общий чат с производством.',
    kind: 'statement',
    expectRoute: 'checkin',
    scenario: 'отчёт + идея (микс)',
  },

  {
    ...
    kind: 'task',
    expectRoute: 'task',
    scenario: 'поставить задачу',
  },
  {
    id: 'T2',
    text: 'Напомни завтра позвонить клиенту',
    kind: 'task',
    expectRoute: 'task',
    scenario: 'поставить задачу/напоминание',
  },
  {
    id: 'S1',
    text: 'Какие у меня задачи?',
    kind: 'show_tasks',
    expectRoute: 'show_tasks',
    scenario: 'мои задачи',
  },
  {
    id: 'S2',
  ...
  {
    id: 'B1',
    text: 'Что я сегодня сделал?',
    kind: 'question',
    expectRoute: 'assistant',
    scenario: 'ловушка: вопрос, не отчёт',
  },
];
