...
import { MiniArrow } from "@/ui/components/dashboard/registry/_kit";
import { cn } from "@/ui/shadcn/lib/utils";

type Direction = DailyDigestGoalAlignmentDayApi["direction"];

const DIRECTION_ARROW: Record<Direction, "up" | "side" | "down"> = {
  to_goal: "up",
  drift: "side",
  against: "down",
};
...
export function GoalCompassCard({
  ...
  const arrow = DIRECTION_ARROW[goal.direction];
