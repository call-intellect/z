...
function AiSummary({ children }: { children: ReactNode }) {
  return (
    ...
    >
      ...
      <div>
        <b style={{ color: CHART.text, fontWeight: 600 }}>Резюме за месяц:</b>{" "}
        {children}
      </div>
    </div>
  );
...
export function MonthSignalsGrid({
  insights,
  frictions,
  clusters,
  risksSummary,
  ...
  return (
    <>
      ...
      <div style={glass()} className="p-6">
        ...
        {!hasRisks ? (
          <p className="text-sm" style={{ color: CHART.faint }}>
            За этот месяц рисков и трений не зафиксировано.
          </p>
        ) : (
      ...
      <div style={glass()} className="p-6">
        ...
        {clusters.length === 0 ? (
          <p className="text-sm" style={{ color: CHART.faint }}>
            За этот месяц новых идей не собрано.
          </p>
        ) : (
          <>
            <div className="flex flex-col">
