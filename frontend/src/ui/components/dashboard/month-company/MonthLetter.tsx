...
import type { MonthlyDigestLetterSectionApi } from "@/api/monthly-digest.api";
...
export function MonthLetter({
  ...
  sections: MonthlyDigestLetterSectionApi[] | null;
  ...
  return (
    <div>
      ...
      >
        {open ? "Свернуть письмо" : "Читать письмо месяца"}
        <ChevronDown
          size={18}
          aria-hidden
