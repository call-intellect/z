...
import { UnitEconomicsOrgQuerySchema, type UnitEconomicsOrgQuery } from './dto/admin-budget.dto';
...
export class OrgEconomicsController {
  constructor(@Inject(UnitEconomicsService) private readonly svc: UnitEconomicsService) {}
