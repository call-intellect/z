...
const SEEDS: SettingSeed[] = [
  {
    ...
    section: 'router',
    severity: 'low',
    description: 'Таймаут (мс) вызова провайдера KIE. По умолчанию 180000 (180 c).',
  },
];
...
async function main(): Promise<void> {
  console.log('=== seed-admin-setting-kie-timeout START ===');
  ...
  console.log('=== seed-admin-setting-kie-timeout DONE ===');
}

main()
  .catch((err) => {
    console.error('seed-admin-setting-kie-timeout FAILED:', err);
    process.exit(1);
  })
  .finally(async () => {
