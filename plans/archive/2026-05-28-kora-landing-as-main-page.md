...
> Реализовано полностью (100%): главная страница / показывает лендинг Кора, auth-редирект на /dashboard работает, CTA ведут на /signup и /login, футер на /privacy и /terms, метаданные обновлены дословно по ТЗ. Подтверждено
