 ...
 * Текущая версия — placeholder, унаследованный из формата block-ingest.prompt.ts
 * (Фаза 0b §6.2). Цель: 1 блок → 1 черновик карточки, в краткой и
 * последовательной форме.
 */

export const REGULATION_EXTRACT_SYSTEM_PROMPT = [
