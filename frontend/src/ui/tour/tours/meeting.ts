/**
 * Тур №3 «Знакомство со встречей». 4 шага. Запускается при первом
 * открытии страницы результата встречи `/m/[id]` после завершения первой
 * встречи пользователя.
 *
 * Source: plans/tz/2026-05-27-tracker-onboarding-tour.md §"Тур №3".
 */
