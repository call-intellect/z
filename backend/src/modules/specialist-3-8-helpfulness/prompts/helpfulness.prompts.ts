...
export const HELPFULNESS_DETECT_SYSTEM_PROMPT = [
  ...
  '4. intensity — 0..1: 0.3 для эпизодического, 0.6 для развёрнутого, 0.9 для глубокого ментoring.',
  '5. evidenceQuote — точная цитата из блока (≤300 символов).',
  '6. confidence — 0..1: 0.5 для одиночной фразы, 0.7-0.9 для явного контекста.',
