...
## Фаза 1 — BE: контролёр внедрения решений + 21-день + метрики + крутилки + value-recap-доведение `[ ]`
...
## Фаза 2 — BE: «висящие решения» + pulse-алерт обратимости + forecaster + лента `[ ]`
